...
// Backend kan soms één object of een array van translations teruggeven.
// Deze schema accepteert beide vormen en normaliseert het naar een array.
const FlexibleTranslationsSchema = z
  .union([TranslationSchema, z.array(TranslationSchema)])
  .transform((value) => {
...
export const LocalizedStringSchema = z.object({
  value: z.string(),
  translation: FlexibleTranslationsSchema,
});
      ...
      .object({
        productinfo: z.object({
          ...
          characteristicinfolist: z
            .object({
              characteristicinfo: z.array(SearchResultCharacteristicInfoSchema),
            })
            .optional(),
        }),
      })
        ...
        specificationinfo: z.object({
          ...
          ingredientset: z
            .object({
              ...
              ingredientdeclaration: LocalizedStringSchema.optional(),
              ingredientdeclarationpreview: LocalizedStringSchema.optional(),
              ingredients: z
                .object({
                  ingredientinfo: z.array(SearchResultIngredientInfoSchema),
                })
                .optional(),
            })
            .optional(),
          allergenset: z
            .object({
              allergens: z.object({
                allergeninfo: z.array(SearchResultAllergenInfoSchema),
              }),
            })
            .optional(),
          nutrientset: z
            .object({
              ...
              nutrientinfolist: z.object({
                nutrientinfo: z.array(SearchResultNutrientInfoSchema),
              }),
            })
            .optional(),
        }),
        ...
        logisticinfo: z.object({
          ...
          impactscoreinfo: z
            .object({
              ...
              farmtofarmgatecarbonfootprint: z.string().optional(),
              cradletomanufacturingcarbonfootprint: z.string().optional(),
